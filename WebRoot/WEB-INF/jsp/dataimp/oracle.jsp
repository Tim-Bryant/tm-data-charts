<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<blockquote class="layui-elem-quote"><i class="layui-icon">&#xe622;</i> Oracle数据库导入</blockquote>
<form class="layui-form" action="">
  <div class="layui-form-item">
    <label class="layui-form-label">服务器地址</label>
    <div class="layui-input-inline">
      <input type="text" name="oracle_ip" value="" required  lay-verify="required" placeholder="服务器地地址" autocomplete="off" class="layui-input">
    </div>
    <label class="layui-form-label">端口号</label>
    <div class="layui-input-inline">
      <input type="text" name="oracle_port" value="1521" required  lay-verify="required" placeholder="端口号" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-form-mid layui-word-aux">1521是默认端口，其它端口请修改</div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">登录名</label>
    <div class="layui-input-inline">
      <input type="text" name="oracle_user" value="" required  lay-verify="required" placeholder="登录名" autocomplete="off" class="layui-input">
    </div>
     <label class="layui-form-label">密码</label>
    <div class="layui-input-inline">
      <input type="password" name="oracle_pwd" value="" required  lay-verify="required" placeholder="密码" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">实例名</label>
    <div class="layui-input-inline">
      <input type="text" name="oracle_dbname" value="" required  lay-verify="required" placeholder="数据库名" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-form-mid layui-word-aux">请输入实例名</div>
  </div>
	...
	<div class="layui-form">
	  		 <div class="layui-form-item">
				    ...
				    <div class="layui-input-inline">
				      ...
				      <button class="layui-btn savings layui-btn-primary" data-method="saveForMenu"><i class="layui-icon">&#xe63c;</i>保存为菜单</button>
			  </div>
